...
<head>
    ...
    <style>
        ...
        <?php echo $less->compileFile($GLOBALS['ROOTPATH'] . '/common/template/header_cps/index.less'); ?>
        <?php echo $less->compileFile('./index.less'); ?>
        <?php echo $less->compileFile($GLOBALS['ROOTPATH'] . '/common/template/footer_cps/index.less'); ?>
    </style>
</head>
<body>
    ...
    <div class="ht960">
    <% } %>
        <?php include($GLOBALS['ROOTPATH'] . '/common/template/header_cps/content.php'); ?>
    </div>
    ...
    <div class="ht960">
    <% } %>
        <?php include($GLOBALS['ROOTPATH'] . '/common/template/footer_cps/content.php'); ?>
    </div>
    ...
    <script>
        require([
            ...
            require([
                '/common/template/header_cps/index.js',
                '/common/template/footer_cps/index.js'
            ], function() {
                require(['./index']);
            });
        });
